...
class AppStore {
  static const tuiLiveKitDocumentUrl =
      "https://cloud.tencent.com/document/product/647/105442";
  ...
  static ValueNotifier<int> currentFragmentIndex = ValueNotifier(
    fragmentIndexRoomList,
  );
}
